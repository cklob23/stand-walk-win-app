...
export default async function DashboardLayout({
    ...
    console.log('[v0] Dashboard layout - pathname:', pathname, 'isCovenantPage:', isCovenantPage, 'role:', profile.role)
      ...
      `)
        ...
        if (allPairings && allPairings.length > 0) {
            ...
            if (!isCovenantPage && !isAdminPage) {
                ...
                console.log('[v0] Leader covenant check - activePairingWithLearner:', activePairingWithLearner?.id, 'covenant_leader:', activePairingWithLearner?.covenant_accepted_leader, 'covenant_learner:', activePairingWithLearner?.covenant_accepted_learner)
    ...
    if (profile.role === 'learner' && !isCovenantPage && !isAdminPage) {
        ...
        console.log('[v0] Learner covenant check - pairing:', learnerPairing?.id, 'covenant_leader:', learnerPairing?.covenant_accepted_leader, 'covenant_learner:', learnerPairing?.covenant_accepted_learner)
